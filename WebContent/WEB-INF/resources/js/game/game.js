...
game.states.menu = function() {
    this.preload = function() {
        this.load.image('day', './resources/assets/bg/day.png');
        this.load.image('night', './resources/assets/bg/night.png');
        this.load.image('player', './resources/assets/b.png');
        this.load.image('s1', './resources/assets/mooncake/11.png');
        this.load.image('s2', './resources/assets/mooncake/22.png');
        this.load.image('1', './resources/assets/mooncake/1.png');
        this.load.image('2', './resources/assets/mooncake/2.png');
        this.load.image('3', './resources/assets/mooncake/3.png');
        this.load.image('4', './resources/assets/mooncake/4.png');
        this.load.image('5', './resources/assets/mooncake/5.png');
        this.load.image('6', './resources/assets/mooncake/6.png');
        this.load.image('7', './resources/assets/mooncake/7.png');
        this.load.image('message', './resources/assets/menu/message.png')
        this.load.image('button', './resources/assets/button.png');
        this.load.audio('bang', './resources/assets/music/bang.wav');
        this.load.audio('music', './resources/assets/music/675.mp3');
    },
