	...
	<div id="wrapper">
				...
				<ul class="nav" id="side-menu">
					<li class="nav-header">
						<div class="dropdown profile-element">
							<span><span class="hide_imgPath hide"></span><img alt="image" id="userImg" class="img-circle"
								src="./resources/images/head_pic.png"
								style="width: 64px; height: 64px" /></span> <a data-toggle="dropdown"
								class="dropdown-toggle" href="#"> <span class="clear">
									<span class="block m-t-xs"><strong class="font-bold"
										id="user_account">${sessionScope.account}</strong></span> <span id="user_type"
									class="text-muted text-xs block">${sessionScope.userType}<b class="caret"></b></span>
							</span>
							</a>
							<ul class="dropdown-menu animated fadeInRight m-t-xs">
								<li class="divider"></li>
								<li><a href="login" id="login_out">安全退出</a></li>
							</ul>
						</div>
					</li>
					<li class="ifType"><a href="#"> <i class="fa fa-users" ></i> <span
							class="nav-label">系统用户</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="userInfo" data-index="0">用户管理</a>
							</li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-newspaper-o"></i> <span
							class="nav-label">校内新闻</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li class="ifType"><a class="J_menuItem" href="newsPublish">新闻发布</a></li>
							<li><a class="J_menuItem" href="newsList">已发布新闻</a></li>
						</ul></li>
					<li><a href="#"> <i class="fa fa-table"></i> <span
							class="nav-label">选课系统</span> <span class="fa arrow"></span>
					</a>
						<ul class="nav nav-second-level">
							<li class="ifType"><a class="J_menuItem" href="curriculumPublish">新增课程</a>
							</li>
							<li><a class="J_menuItem" href="curriculumList">课程列表</a>
							</li>
							<li><a class="J_menuItem" href="myCurriculumList">课表/选课</a>
							</li>
						</ul></li>
					<li><a href="#"><i class="fa fa-book"></i> <span
							class="nav-label">图书管理</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li class="ifType"><a class="J_menuItem" href="addBook">新增图书</a></li>
							<li><a class="J_menuItem" href="bookList">图书管理</a></li>
							<li><a class="J_menuItem" href="myBorrowBook">我的借阅</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-map-signs"></i> <span
							class="nav-label">地图应用</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="mapCheck">查询路线</a></li>
						</ul></li>
					<li><a href="#"><i class="fa fa-gamepad"></i> <span
							class="nav-label">休闲娱乐</span><span class="fa arrow"></span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="game">打月饼游戏</a></li>
						</ul></li>
					<!-- 接收消息 -->

					<li class="hide"><a href="mailbox.html"><i class="fa fa-envelope"></i>
							<span class="nav-label">信箱 </span><span
							class="label label-warning pull-right">16</span></a>
						<ul class="nav nav-second-level">
							<li><a class="J_menuItem" href="mailbox.html">收件箱<span
		...
		<div id="page-wrapper" class="gray-bg dashbard-1">
							...
							<ul class="dropdown-menu dropdown-messages">
								<li class="m-t-xs">
									<div class="dropdown-messages-box">
										<a href="profile.html" class="pull-left"> <img alt="image"
											class="img-circle" src="./resources/images/head_pic.png">
										</a>
										<div class="media-body">
											<small class="pull-right">46小时前</small> <strong>test-1</strong>
											这是一条测试信息 <br> <small class="text-muted">3天前
												2019.03.11</small>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="dropdown-messages-box">
										...
										<div class="media-body ">
											<small class="pull-right text-navy">25小时前</small> <strong>test-2</strong>
											这又是一条测试信息 <br> <small class="text-muted">昨天</small>
										</div>
									</div>
								</li>
								<li class="divider"></li>
			...
			<div class="row J_mainContent" id="content-main">
				<iframe class="J_iframe" name="iframe0" width="100%" height="100%"
					src="showIndex" frameborder="0" data-id="showIndex" seamless></iframe>
			</div>
			<div class="footer">
				<div class="pull-right">
					&copy; 2019-2099 <a href="" target="_blank">实训小组</a>
				</div>
			</div>
		</div>
		<!--右侧部分结束-->
		...
		<div class="small-chat-box fadeInRight animated hide">
			...
			<div class="heading" draggable="true">
				<small class="chat-date pull-right"> 2019.3.1 </small> 与 Boss 聊天中
			</div>
			...
			<div class="content">
				...
				<div class="right">
					<div class="author-name">
						test <small class="chat-date"> 11:24 </small>
					</div>
					<div class="chat-message">你好</div>
				</div>
				<div class="left">
					<div class="author-name">
						Boss <small class="chat-date"> 08:45 </small>
					</div>
					<div class="chat-message active">你好</div>
				</div>
				<div class="right">
					...
					<div class="chat-message">我是test</div>
				</div>
				<div class="left">
					<div class="author-name">
						Boss <small class="chat-date"> 08:45 </small>
					</div>
					<div class="chat-message active">我是Boss</div>
				</div>
			</div>
			<div class="form-chat">
...
if($("#user_type").text() == "普通用户"){
		$(".ifType").hide();
	}
	
var a = $("#user_account").html();

if(a == "184712056"){
	$("#userImg").attr("src","./resources/images/IMG_1740.JPG")
}
if(a == "184712064"){
	$("#userImg").attr("src","./resources/images/IMG_1744.JPG")
}
if(a == "184712044"){
	$("#userImg").attr("src","./resources/images/IMG_1741.JPG")
}
if(a == "184712062"){
	$("#userImg").attr("src","./resources/images/IMG_1743.JPG")
}
if(a == "184712026"){
	$("#userImg").attr("src","./resources/images/IMG_1742.JPG")
}
if(a == "184712042"){
	$("#userImg").attr("src","./resources/images/IMG_1745.JPG")
}
</script>
